...
<div class="modal fade" id="suathongtinthuocJSON" tabindex="-1"
				...
				<form>
					...
					<div class="form-group">
						<label for="recipient-name" class="col-form-label">Giá
							...
							class="form-control form-control-sm" id="costPrice">
					</div>
					<div class="form-group">
						<label for="recipient-name" class="col-form-label">Giá
							bán:</label> <input type="text" value=""
							class="form-control form-control-sm" id="retailPrice">
					</div>
				</form>
			</div>
